...
const valoria_version_json_1 = require("../Defaults/valoria-version.json");
...
exports.Browsers = {
    ...
    valoria: (browser) => ['Valoria', browser, '6.5.0'],
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/iitsyaman/valoria/main/lib/Defaults/valoria-version.json';
    try {
        ...
        return {
            version: valoria_version_json_1.version,
            isLatest: false,
            error
        };
    }
};
exports.fetchLatestValoriaVersion = fetchLatestBaileysVersion;
