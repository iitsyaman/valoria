...
export type SocketConfig = {
    ...
    /** should valoria use the mobile api instead of the multi device api
    ...
    */
    ...
    /** Should Valoria ask the phone for full history, will be received async */
    syncFullHistory: boolean;
    /** Should valoria fire init queries automatically, default true */
