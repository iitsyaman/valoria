...
export type ValoriaEvent = keyof ValoriaEventMap;
export interface ValoriaEventEmitter {
    on<T extends keyof ValoriaEventMap>(event: T, listener: (arg: ValoriaEventMap[T]) => void): void;
    off<T extends keyof ValoriaEventMap>(event: T, listener: (arg: ValoriaEventMap[T]) => void): void;
    removeAllListeners<T extends keyof ValoriaEventMap>(event: T): void;
    emit<T extends keyof ValoriaEventMap>(event: T, arg: ValoriaEventMap[T]): boolean;
}
