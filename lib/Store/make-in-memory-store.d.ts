...
import type { ValoriaEventEmitter, Chat, ConnectionState, Contact, GroupMetadata, PresenceData, WAMessage, WAMessageCursor, WAMessageKey } from '../Types';
...
export type ValoriaInMemoryStoreConfig = {
    chatKey?: Comparable<Chat, string>;
    labelAssociationKey?: Comparable<LabelAssociation, string>;
    logger?: ILogger;
    socket?: WASocket;
};
declare const _default: (config: ValoriaInMemoryStoreConfig) => {
    ...
    bind: (ev: ValoriaEventEmitter) => void;
